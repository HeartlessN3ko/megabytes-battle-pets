    ...
    <ImageBackground source={require('../../assets/backgrounds/bg916.png')} style={styles.bg} resizeMode="cover">
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        <View style={styles.card}>
          ...
          <Text style={styles.sub}>Campaign terminal is under construction.</Text>
          <Text style={styles.body}>
            This slot replaces the previous Battle tab for demo builds. Training battles are now launched from the Training Center room.
          </Text>
        </View>
      </SafeAreaView>
    </ImageBackground>

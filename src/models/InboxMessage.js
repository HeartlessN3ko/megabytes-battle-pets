...
const InboxMessageSchema = new mongoose.Schema(
  {
    ...
    kind: {
      type: String,
      enum: ['market_delivery', 'market_confirmation', 'system', 'reward'],
      default: 'system',
      index: true,
    },
    ...
    // readyAt gates visibility/claiming; null = ready now.
    // Used for marketplace dual-stage delivery (confirmation immediate, delivery delayed).

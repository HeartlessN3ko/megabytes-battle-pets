...
export default function CashShopScreen() {
  return (
    <ImageBackground source={require('../../assets/backgrounds/bg916.jpg')} style={styles.bg} resizeMode="cover">
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        <View style={styles.card}>
          <Text style={styles.title}>REAL MONEY SHOP</Text>
          <Text style={styles.sub}>Coming soon</Text>
          <Text style={styles.body}>This section will host premium packs and supporter cosmetics. Layout reserved for future implementation.</Text>
        </View>
      </SafeAreaView>
    </ImageBackground>
  );
